...
import com.cisco.hicn.hproxylibrary.utility.Constants;
...
public class ProxyBackend implements Runnable, Handler.Callback {
    ...
    protected final Service mParentService;
...
//        }
    ...
    public void run() {
        ...
        boolean defaultDisableSD =  Boolean.parseBoolean(mParentService.getString(R.string.pref_hproxy_disable_sd_default));
        boolean disableSD = prefs.getBoolean(mParentService.getString(R.string.pref_hproxy_disable_sd_key), defaultDisableSD);

        String server = prefs.getString(mParentService.getString(R.string.pref_hproxy_server_key),
                mParentService.getString(R.string.pref_hproxy_server_default));
        int port = Integer.parseInt(prefs.getString(mParentService.getString(R.string.pref_hproxy_port_key),
                mParentService.getString(R.string.pref_hproxy_port_default)));

        HProxyLibrary.getInstance().setProxyInstance(this);
        HProxyLibrary.getInstance().start(disableSD, server, port); //mServerName, mServerPort);
